...
I made a blog page (which ended up in the recycle bin because I didn't like it that much) and that was about it. I didn't do much since I was struggling for hours on CSS formatting and I had work to take care of. After that, I played around with React Native and didn't make much either.
...
I decided that Bootstrap would handle my CSS to make my site look better, so I installed it. Shortly after, I was warned by my friend not to use it and told me to switch to Tailwind instead. I still continue to use the icons that Bootstrap provide because they're actually pretty nice.
